    ...
    try:
        ...
        if already_owned_asset is None:
            asset_dict = {
                ...
                "averagePrice": new_amount_invested / new_position,
                "userId": user_id,
            }
        ...
        raise HTTPException(
            status_code=500,
            detail={"message": "Error completing the transaction" + str(e)},
        )
        ...
        try:
            ...
            return ReturnedAsset(
                symbol=updated_asset.get("symbol"),
                position=updated_asset.get("position"),
            )
        except Exception as e:
            return JSONResponse(
                status_code=500,
                content={"message": "Error completing the transaction" + str(e)},
            )
